        ...
        if ( ! class_exists( 'WPCleverWooct' ) && class_exists( 'WC_Product' ) ) {
            class WPCleverWooct {
                    ...
                    <div class="wpclever_settings_page wrap">
                        <div class="wpclever_settings_page_header">
                            ...
                            <div class="wpclever_settings_page_header_text">
                                <div class="wpclever_settings_page_title"><?php echo esc_html__( 'WPC Countdown Timer', 'wpc-countdown-timer' ) . ' ' . esc_html( WOOCT_VERSION ) . ' ' . ( defined( 'WOOCT_PREMIUM' ) ? '<span class="premium" style="display: none">' . esc_html__( 'Premium', 'wpc-countdown-timer' ) . '</span>' : '' ); ?></div>
                                ...
                                <form method="post" action="options.php">
                                    <table class="form-table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label> <select name="wooct_settings[position_archive]">
                                                ...
                                                <p class="description"><?php echo sprintf( /* translators: shortcode */ esc_html__( 'You also can use shortcode %s to show the countdown timer for current product.', 'wpc-countdown-timer' ), '<code>[wooct_product]</code>' ); ?></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row"><?php esc_html_e( 'Position on single', 'wpc-countdown-timer' ); ?></th>
                                            <td>
                                                <label> <select name="wooct_settings[position_single]">
                                        ...
                                        <tr class="submit">
                                            <th colspan="2">
                                                ...
                                                <a style="display: none;" class="wpclever_export"
                                                   ...
                                                   data-name="settings"
                                                   href="#"><?php esc_html_e( 'import / export', 'wpc-countdown-timer' ); ?></a>
                                            </th>
                                        </tr>
                                    </table>
                                </form>
                                ...
                                <form method="post" action="options.php">
                                    <table class="form-table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label> <select name="wooct_localization[zero_plural]">
                ...
                function action_links( $links, $file ) {
                    ...
                    if ( $plugin === $file ) {
                        $settings         = '<a href="' . esc_url( admin_url( 'admin.php?page=wpclever-wooct&tab=settings' ) ) . '">' . esc_html__( 'Settings', 'wpc-countdown-timer' ) . '</a>';
                        $links['premium'] = '<a href="' . esc_url( admin_url( 'admin.php?page=wpclever-wooct&tab=premium' ) ) . '">' . esc_html__( 'Premium Version', 'wpc-countdown-timer' ) . '</a>';
                ...
                function save_variation_settings( $post_id ) {
                    // phpcs:ignore WordPress.Security.NonceVerification.Missing -- Security already verified by WooCommerce before firing this hook.
                ...
                function get_countdown( $style, $time_start, $time_end, $text_above, $text_under, $text_ended, $color = '', $product_id = 0 ) {
                    ...
                    if ( ! empty( $time_end ) && self::check_time_start( $time_start ) ) {
                        if ( ! empty( $color ) ) {
                            switch ( $style ) {
                                case '07':
                                    $css = '.wooct-countdown.wooct-style-07.wooct-countdown-' . esc_attr( $key ) . ' .wooct-timer .c100 .bar, .wooct-countdown.wooct-style-07.wooct-countdown-' . esc_attr( $key ) . ' .wooct-timer .c100 .fill { border-color: ' . esc_attr( $color ) . '} .wooct-countdown.wooct-style-07.wooct-countdown-' . esc_attr( $key ) . ' .wooct-timer .c100 > span.text > span:first-child { color: ' . esc_attr( $color ) . '; }';

                                    break;
                                case '06':
                                    $css = '.wooct-countdown.wooct-style-06.wooct-countdown-' . esc_attr( $key ) . ' .wooct-timer > span { border-top-color: ' . esc_attr( $color ) . '; border-bottom-color: ' . esc_attr( $color ) . '; border-left-color: ' . esc_attr( $color ) . ';  } .wooct-countdown.wooct-style-06.wooct-countdown-' . esc_attr( $key ) . ' .wooct-timer > span span:first-child { color: ' . esc_attr( $color ) . '; }';

                                    break;
                                case '03':
                                    $css = '.wooct-countdown.wooct-style-03.wooct-countdown-' . esc_attr( $key ) . ' .wooct-timer > span { border-color: ' . esc_attr( $color ) . '; } .wooct-countdown.wooct-style-03.wooct-countdown-' . esc_attr( $key ) . ' .wooct-timer > span span:first-child { color: ' . esc_attr( $color ) . '; }';

                                    break;
                                case '02':
                                    $css = '.wooct-countdown.wooct-style-02.wooct-countdown-' . esc_attr( $key ) . ' .wooct-timer > span { border-color: ' . esc_attr( $color ) . '; } .wooct-countdown.wooct-style-02.wooct-countdown-' . esc_attr( $key ) . ' .wooct-timer > span span:first-child { color: ' . esc_attr( $color ) . '; }';

                                    break;
                                case '01':
                                    $css = '.wooct-countdown.wooct-style-01.wooct-countdown-' . esc_attr( $key ) . ' .wooct-timer { color: ' . esc_attr( $color ) . '; }';
