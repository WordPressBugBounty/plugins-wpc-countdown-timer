			...
			class WPCleverWooct {
				...
				function admin_menu_content() {
                    ...
                    <div class="wpclever_settings_page wrap">
                        <h1 class="wpclever_settings_page_title"><?php echo esc_html__( 'WPC Countdown Timer', 'wpc-countdown-timer' ) . ' ' . esc_html( WOOCT_VERSION ) . ' ' . ( defined( 'WOOCT_PREMIUM' ) ? '<span class="premium" style="display: none">' . esc_html__( 'Premium', 'wpc-countdown-timer' ) . '</span>' : '' ); ?></h1>
